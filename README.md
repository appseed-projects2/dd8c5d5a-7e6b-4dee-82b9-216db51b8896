...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-22 13:21`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/dd8c5d5a-7e6b-4dee-82b9-216db51b8896.git
$ cd dd8c5d5a-7e6b-4dee-82b9-216db51b8896
```
